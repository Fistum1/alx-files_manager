...
/**
 * A module with file utilities
 */

const fileUtils = {
  /**
   * It validates if body is valid for creating file
   * 
  ...
  /**
   * It saves files to database and disk
   * 
  ...
  /**
   * It updates a file document in database
   * 
  ...
  /**
   * It makes a file public or private
   * 
   * @request {request_object} express request obj
  ...
  /**
   * It checks if a file is public and belongs
   * to a specific user
   * 
  ...
  /**
   * It gets a files data from database
   * 
